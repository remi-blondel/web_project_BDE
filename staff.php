...
HTML;
        ...
        while ($order = $stmt->fetch())
        {
            ...
            $orders_tab .= "<td><a class='btn btn-danger glyphicon glyphicon-remove' role='button' href=management/manage_orders.php?action=delorder&idprod={$order['id_product']}&iduser={$order['id_user']}></a></td>";
            $orders_tab .= "</tr>";
        }
